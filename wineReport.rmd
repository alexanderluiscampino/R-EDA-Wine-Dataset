...
#summary(wine[2:13])#Not interested in the first column, since it is just the Col#
...
wine$quality_bucket <- cut(wine$quality, breaks = c(2,4,6,8)) #Divide quality into buckets

wine$quality.cat <- wine$quality_bucket
wine$quality.cat <-mapvalues(wine$quality.cat, from = c("(2,4]", "(4,6]", "(6,8]"), 
          to = c("Bad", "Medium", "Good")) #Give those buckets qualitative terms
...
quality_hist <- ggplot(data = wine, aes(x=quality)) +
  geom_histogram(binwidth =1,  color = 'orange') +
  ggtitle('Quality Rating') +
  xlab('Quality') + ylab('Count') +
  plot_text_transfom

alcohol_hist <- ggplot(data = wine, aes(x=alcohol)) +
  geom_histogram(binwidth =0.2,  color = 'orange') +
  ggtitle('Alcohol Content') +
  xlab('Alcohol [%]') + ylab('Count') +
  plot_text_transfom

density_hist <- ggplot(data = wine, aes(x=density)) +
  geom_histogram(binwidth =0.001,  color = 'orange') +
  ggtitle('Density') +
  xlab('Density [g/cm^3]') + ylab('Count') +
  plot_text_transfom

pH_hist <- ggplot(data = wine, aes(x=pH)) +
...
Density has very little variation, being very similar to water. Quality wise, most wines are 5 and 6 rating.
...
residual.sugar_hist <- ggplot(data = wine, aes(x=residual.sugar)) +
  geom_histogram(binwidth =0.05,  color = 'orange') +
...
volatile.acidity_hist <- ggplot(data = wine, aes(x=volatile.acidity)) +
  geom_histogram(binwidth =0.1,  color = 'orange')+
  ggtitle('Volatile Acidity') +
  xlab('Volatile Acidity [g/l]') + ylab('Count') +
  plot_text_transfom
 
citric.acid_hist <- ggplot(data = wine, aes(x=citric.acid)) +
  geom_histogram(binwidth =0.05,  color = 'orange') +
  ggtitle('Citric Acid') +
  xlab('Citric Acid [g/l]') + ylab('Count') +
  plot_text_transfom



fixed.acidity_hist <- ggplot(data = wine, aes(x=fixed.acidity)) +
  geom_histogram(binwidth =1,  color = 'orange') +
  ggtitle('Fixed Acidity') +
  xlab('Fixed Acidity [g/l]') + ylab('Count') +
  plot_text_transfom
...
Since the Residual Sugar distribution was extremely right skewed, a Log10 transformation was applied.. The Citric Acid is also unsual, hard to determine if it is bimodal or not. The Volatile and Fixed Acidity are close to a normal distribution.
...
total.sulfur.dioxide_hist <- ggplot(data = wine, aes(x=total.sulfur.dioxide)) +
  geom_histogram(binwidth =0.1,  color = 'orange') +
  ggtitle('Total Sulfur Dioxide [Log10]') +
  xlab('Total Sulfur Dioxide [mg/l]') + ylab('Count') + 
  plot_text_transfom +
  scale_x_continuous(trans='log10', breaks = c(10,20,50, 100))


free.sulfur.dioxide_hist <- ggplot(data = wine, aes(x=free.sulfur.dioxide)) +
  geom_histogram(binwidth =0.1,  color = 'orange') +
  ggtitle('Free Sulfur Dioxide [Log10]') +
  xlab('Free Sulfur Dioxide [mg/l]') + ylab('Count') + 
  plot_text_transfom +
  scale_x_continuous(trans='log10', breaks = c(1,3,10, 35, 70))

sulphates_hist <- ggplot(data = wine, aes(x=sulphates)) +
  geom_histogram(binwidth =0.05,  color = 'orange') +
  ggtitle('Sulphates [Log10]') +
  xlab('Sulphates [g/l]') + ylab('Count') + 
  plot_text_transfom +
  scale_x_continuous(trans='log10', breaks = c(0.5,0.7,1))

chlorides_hist <- ggplot(data = wine, aes(x=chlorides)) +
  geom_histogram(binwidth =0.05,  color = 'orange') +
  ggtitle('Chlorides [Log10]') +
  xlab('Chlorides [g/l]') + ylab('Count') + 
  plot_text_transfom +
...
plot_fix_acidity_pH <- ggplot(data = wine, aes(x = fixed.acidity, y = pH))+
  geom_point(position=position_jitter(), alpha=1/4, size = 2, color = "orange") +
  ggtitle('Scatter Plot - pH Vs Fixed Acidity') +
  xlab('Fixed Acidity [g/l]') + ylab('pH') + 
  plot_text_transfom +
  geom_smooth(method = "lm")

plot_fix_acidity_citac <- ggplot(data = wine, aes(x = fixed.acidity, y = citric.acid))+
  geom_point(position=position_jitter(), alpha=1/4, size = 2, color = "orange") +
  ggtitle('Scatter Plot - Citric Acid Vs Fixed Acidity') +
  xlab('Fixed Acidity [g/l]') + ylab('Citric Acid [g/l]') + 
  plot_text_transfom +
  geom_smooth(method = "lm")

plot_fix_acidity_density <- ggplot(data = wine, aes(x = fixed.acidity, y = density))+
  geom_point(position=position_jitter(), alpha=1/4, size = 2, color = "orange") +
  ggtitle('Scatter Plot - Density Vs Fixed Acidity') +
  xlab('Fixed Acidity [g/l]') + ylab('Density [g/cm^3]') + 
  plot_text_transfom +
  geom_smooth(method = "lm")



grid.arrange(plot_fix_acidity_pH,plot_fix_acidity_citac, plot_fix_acidity_density,ncol =2)
...
plot_ciac_volac <- ggplot(data = wine, aes(x = citric.acid, y = volatile.acidity))+
  geom_point(position=position_jitter(), alpha=1/4, size = 2, color = "orange") +
  ggtitle('Scatter Plot - Volatile Acidity Vs Citric Acid') +
  xlab('Citric Acid [g/l]') + ylab('Volatile Acidity [g/l]') + 
  plot_text_transfom +
  geom_smooth(method = "lm")

plot_ciac_ph <- ggplot(data = wine, aes(x = citric.acid, y = pH))+
  geom_point(position=position_jitter(), alpha=1/4, size = 2, color = "orange") +
  ggtitle('Scatter Plot - pH Vs Citric Acid') +
  xlab('Citric Acid [g/l]') + ylab('pH') + 
  plot_text_transfom +
  geom_smooth(method = "lm")

plot_fsd_tsd <- ggplot(data = wine, aes(x = free.sulfur.dioxide, y = total.sulfur.dioxide))+
  geom_point(position=position_jitter(), alpha=1/4, size = 2, color = "orange") +
  ggtitle('Scatter Plot - Total SO2 Vs Free SO2') +
  xlab('Total Sulfur Dioxide [g/l]') + ylab('Free Sulfur Dioxide [mg/l]') + 
  plot_text_transfom +
  geom_smooth(method = "lm")

plot_den_alc <- ggplot(data = wine, aes(y = density, x = alcohol))+
  geom_point(position=position_jitter(), alpha=1/4, size = 2, color = "orange") +
  ggtitle('Scatter Plot - Density Vs Alcohol') +
  ylab('Density [g/cm^3]') + xlab('Alcohol [%]') + 
  plot_text_transfom +
  geom_smooth(method = "lm")

grid.arrange(plot_ciac_volac, plot_ciac_ph, plot_fsd_tsd , plot_den_alc, ncol =2)
...
box_alc_quality <- ggplot(data = wine, aes(x = quality.cat, y = alcohol)) +
  ggtitle('Box Plot - Alcohol Vs Quality') +
  xlab('Quality') + ylab('Alcohol [%]') + 
  geom_boxplot() +
  plot_text_transfom

box_pH_quality <- ggplot(data = wine, aes(x = quality.cat, y = pH)) +
  ggtitle('Box Plot - pH Vs Quality') +
  xlab('Quality') + ylab('pH') + 
  geom_boxplot() +
  plot_text_transfom

box_sul_quality <- ggplot(data = wine, aes(x = quality.cat, y = sulphates)) +
  ggtitle('Box Plot - Sulphates Vs Quality') +
  xlab('Quality') + ylab('Sulphates [g/l]') + 
  geom_boxplot() +
  plot_text_transfom

box_fac_quality <- ggplot(data = wine, aes(x = quality.cat, y = fixed.acidity)) +
  ggtitle('Box Plot - Fixed Acidity Vs Quality') +
  xlab('Quality') + ylab('Fixed Acidty [g/l]') + 
  geom_boxplot() +
  plot_text_transfom
...
box_volac_quality <- ggplot(data = wine, aes(x = quality.cat, y = volatile.acidity)) +
  ggtitle('Box Plot - Volatile Acidity Vs Quality') +
  xlab('Quality') + ylab('Volatile Acidity [g/l]') + 
  geom_boxplot() +
  plot_text_transfom

box_citac_quality <- ggplot(data = wine, aes(x = quality.cat, y = citric.acid)) +
  ggtitle('Box Plot - Citric Acid Vs Quality') +
  xlab('Quality') + ylab('Citric Acid  [g/l]') + 
  geom_boxplot() +
  plot_text_transfom

box_fsd_quality <- ggplot(data = wine, aes(x = quality.cat, y = free.sulfur.dioxide)) +
  ggtitle('Box Plot - Free S02 Vs Quality') +
  xlab('Quality') + ylab('Free SO2 [mg/l]') + 
  geom_boxplot() +
  plot_text_transfom

box_tsd_quality <- ggplot(data = wine, aes(x = quality.cat, y = total.sulfur.dioxide)) +
  ggtitle('Box Plot - Total SO2 Vs Quality') +
  xlab('Quality') + ylab('Total SO2 [mg/l]') + 
  geom_boxplot() +
  plot_text_transfom
...
ggplot(data = wine, aes(y = alcohol, x = sulphates, color = quality.cat))+
  ...
  ggtitle('Scatter Plot - Alcohol Content Vs Sulphates - Colored by Quality') +
...
ggplot(data = wine, aes(y = citric.acid, x = fixed.acidity, color = quality.cat))+
  geom_point(position=position_jitter(), alpha=1, size = 1.5) +
  scale_color_brewer(type = 'qual', palette = 2,
    guide = guide_legend(title = 'Quality', reverse = T,
    override.aes = list(alpha = 1, size = 2)))+
  ggtitle('Scatter Plot - Fixed Acidity Vs Citric Acid - Colored by Quality') +
...
scatter_plot2 <- ggplot(data = wine, aes(x = alcohol, y = volatile.acidity, color = quality.cat))+
  geom_point(position=position_jitter(), alpha=1, size = 2) +
  scale_color_brewer(type = 'qual', palette = 2,
    guide = guide_legend(title = 'Quality', reverse = T,
    override.aes = list(alpha = 1, size = 2)))+
  ggtitle('Scatter Plot - Alcohol Content Vs Volatile Acidity - Colored by Quality Buckets') +
